...
Afin de simplifier les notations ult�rieurement, on d�finit pour la cha�ne de Markov $M$, la matrice des probabilit�s de transition $A_M \in M_N\pa{\mathbb{R}}$~: \indexfrr{notation}{probabilit� de transition}
...
On d�finit �galement le vecteur des probabilit�s d'entr�es $\pi_M \in \mathbb{R}^N$ :
...
Les formules de r�estimation (voir \citeindex{Bottou1991}) � utiliser lors de l'algorithme de Baum-Welch sont les suivantes pour les s�quences d'observations $\vecteur{O^k_1}{O^k_{T_k}}_{1 \leqslant k \leqslant K}$, on note $P_k = f\pa{O^k|M}$ o� $f$ est la densit� des s�quences d'observations~:%
