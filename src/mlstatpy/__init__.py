...
<opml version="1.0">
    ...
    <body>
        <outline text="mlstatpy"
            title="mlstatpy"
            type="rss"
            xmlUrl="http://www.xavierdupre.fr/app/mlstatpy/helpsphinx/_downloads/rss.xml"
            htmlUrl="http://www.xavierdupre.fr/app/mlstatpy/helpsphinx/blog/main_0000.html" />
    </body>
</opml>
"""
