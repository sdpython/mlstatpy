...
:math:`\frac{\lambda \mu}{\mu - \lambda }`. Ce temps est égal à
...
Par conséquent : :math:`A_1 = 0` et :math:`p_1(t) = S \mu t \; e^{- S \mu t}`. On pose maintenant :math:`p_2(t) = C_2(t) e^{- S \mu t}`.
La résolution de l'équation différentielle :eq:`ampoule_diff_2` pour :math:`n=2`
aboutit à :
...
.. [Faure2000] Précis de recherche opérationnelle, 5ième édition,
